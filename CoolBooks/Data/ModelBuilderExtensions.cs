    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void SeedAuthor(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>()
                .HasData(
                new Author { Id = 1, FirstName = "Andrzej", LastName = "Sapkowski", BirthDate = new DateTime(1948, 6, 21), Created = DateTime.Now, ImagePath = "/images/Authors/1.jpg" },
                new Author { Id = 2, FirstName = "Richard", LastName = "Osman", BirthDate = new DateTime(1970, 11, 28), Created = DateTime.Now, ImagePath = "/images/Authors/2.jpg" },
                new Author { Id = 3, FirstName = "Carl", LastName = "Barks", BirthDate = new DateTime(1901, 3, 27), Created = DateTime.Now, ImagePath = "/images/Authors/3.jpg" },
                new Author { Id = 4, FirstName = "Dave", LastName = "Pelzer", BirthDate = new DateTime(1960, 12, 29), Created = DateTime.Now, ImagePath = "/images/Authors/4.jpg"},
                new Author { Id = 5, FirstName = "John", LastName = "Cho", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/Authors/5.jpg"},
                new Author { Id = 6, FirstName = "Sally", LastName = "Rooney", BirthDate = new DateTime(1991, 2, 20), Created = DateTime.Now, ImagePath = "/images/Authors/6.jpg" },
                new Author { Id = 7, FirstName = "Laura", LastName = "Dave", BirthDate = new DateTime(1977, 7, 18), Created = DateTime.Now, ImagePath = "/images/Authors/7.jpg" },
                new Author { Id = 8, FirstName = "Taylor", LastName = "Reid", BirthDate = new DateTime(1983, 12, 20), Created = DateTime.Now, ImagePath = "/images/Authors/8.jpg" },
                new Author { Id = 9, FirstName = "Sarah", LastName = "Maas", BirthDate = new DateTime(1986, 3, 5), Created = DateTime.Now, ImagePath = "/images/Authors/9.jpg" },
                new Author { Id = 10, FirstName = "Jenny", LastName = "Lawson", BirthDate = new DateTime(1973, 12, 29), Created = DateTime.Now, ImagePath = "/images/Authors/10.jpg" },
                new Author { Id = 11, FirstName = "Grady", LastName = "Hendrix", BirthDate = new DateTime(1948, 5, 13), Created = DateTime.Now, ImagePath = "/images/Authors/11.jpg" },
                new Author { Id = 12, FirstName = "Andy", LastName = "Weir", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/Authors/12.jpg" },
                new Author { Id = 13, FirstName = "Emily", LastName = "Henry", BirthDate = new DateTime(1995, 11, 17), Created = DateTime.Now, ImagePath = "/images/Authors/13.jpg" },
                new Author { Id = 14, FirstName = "John", LastName = "Green", BirthDate = new DateTime(1977, 8, 24), Created = DateTime.Now, ImagePath = "/images/Authors/14.jpg" },
                new Author { Id = 15, FirstName = "Michelle", LastName = "Zauner", BirthDate = new DateTime(1989, 3, 29), Created = DateTime.Now, ImagePath = "/images/Authors/15.jpg" },
                new Author { Id = 16, FirstName = "Patrick", LastName = "Keefe", BirthDate = new DateTime(1976, 1, 15), Created = DateTime.Now, ImagePath = "/images/Authors/16.jpg" },
                new Author { Id = 17, FirstName = "Rachel", LastName = "Smythe", BirthDate = new DateTime(1986, 9, 19), Created = DateTime.Now, ImagePath = "/images/Authors/17.jpg" },
                new Author { Id = 18, FirstName = "Leigh", LastName = "Bardugo", BirthDate = new DateTime(1975, 5, 6), Created = DateTime.Now, ImagePath = "/images/Authors/18.jpg" },
                new Author { Id = 19, FirstName = "Angeline", LastName = "Boulley", BirthDate = new DateTime(1966, 4, 27), Created = DateTime.Now, ImagePath = "/images/Authors/19.jpg" },
                new Author { Id = 20, FirstName = "Elena", LastName = "Armas", BirthDate = new DateTime(1989, 1, 30), Created = DateTime.Now, ImagePath = "/images/Authors/20.jpg" }
        ...
        public static void SeedReview(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Review>()
                ...
                new Review { Id = 6, BookId = 6, Title = "Eoins review", Text = "when i was diagnosed with covid i thought that being isolated to my bedroom for two weeks was the most boring thing in the world - Sally Rooney has now proven me wrong.", Rating = 1, Created = DateTime.Now},
                new Review { Id = 7, BookId = 7, Title = "Emilys review", Text = "I'm wondering how these books become the winner's of the CoolBooks Choice Awards. Are we reading the same books ? This was....meh ", Rating = 2, Created = DateTime.Now },
                new Review { Id = 8, BookId = 8, Title = "Chans review", Text = "i find myself once again reading a TJR book and reconsidering my life decisions leading to me this point", Rating = 3, Created = DateTime.Now },
                new Review { Id = 9, BookId = 9, Title = "Cindys review", Text = "I took an edible and now I'm too high to write this review", Rating = 2, Created = DateTime.Now },
                new Review { Id = 10, BookId = 10, Title = "The Story Girls review", Text = "Loved this! Some parts were hilarious, some were just very real about her depression, and some I related to.", Rating = 5, Created = DateTime.Now },
                new Review { Id = 11, BookId = 11, Title = "Barbaras review", Text = "Grady Hendrix does it again. I thoroughly enjoyed this book, it took me back to the slasher movies I loved watching. I can't wait for his next one ", Rating = 4, Created = DateTime.Now },
                new Review { Id = 12, BookId = 12, Title = "James review", Text = "Terrific fun from start to finish. Also the rare book I feel I could happily recommend to just about anyone. My favourite read of the year thus far.", Rating = 5, Created = DateTime.Now },
                new Review { Id = 13, BookId = 13, Title = "Ches review", Text = "ladies, if a man pulls a \"sad puppy face\" at you, run as fast as you can.", Rating = 1, Created = DateTime.Now },
                new Review { Id = 14, BookId = 14, Title = "Alexandras review", Text = "short, sweet, and just what i needed. i can’t wait to revisit some of these chapters for years to come.", Rating = 4, Created = DateTime.Now },
                new Review { Id = 15, BookId = 15, Title = "Jessicas review", Text = "i feel like this book wasnt written for readers, but for MZ herself. its a cathartic exercise through grief and heartbreak and life. its extremely personal, which makes me not want to review this. but i genuinely hope it helped MZ work through her pain and sorrow. im gonna go call my mom now.", Rating = 4, Created = DateTime.Now },
                new Review { Id = 16, BookId = 16, Title = "Tracis review", Text = "This is A+ reporting and storytelling. The story of the Sackler family is expertly laid out for the reader. Riveting and sickening. Investigative journalism at its best. Read this book.", Rating = 5, Created = DateTime.Now },
                new Review { Id = 17, BookId = 17, Title = "Vinas review", Text = "*PRAYS THE NETFLIX GODS REALLY MAKES THIS A SHOW*", Rating = 5, Created = DateTime.Now },
                new Review { Id = 18, BookId = 18, Title = "Aprils review", Text = "Not gonna lie, I do not buy that very convenient ending", Rating = 4, Created = DateTime.Now },
                new Review { Id = 19, BookId = 19, Title = "Jessicas review", Text = "If I hear \"Secret Squirrel\" one more time.....", Rating = 3, Created = DateTime.Now },
                new Review { Id = 20, BookId = 20, Title = "Hannahs review", Text = "I really suffered through this entire thing to get to the smut only to have him say “I want to feel you milking me, baby“ while using a (most likely) expired condom", Rating = 1, Created = DateTime.Now }
