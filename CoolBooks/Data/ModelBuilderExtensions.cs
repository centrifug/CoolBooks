    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void SeedAuthor(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>()
                .HasData(
                new Author { Id = 1, FirstName = "Andrzej", LastName = "Sapkowski", BirthDate = new DateTime(1948, 6, 21), Created = DateTime.Now, ImagePath = "/images/Authors/1.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating=1 },
                new Author { Id = 2, FirstName = "Richard", LastName = "Osman", BirthDate = new DateTime(1970, 11, 28), Created = DateTime.Now, ImagePath = "/images/Authors/2.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 2 },
                new Author { Id = 3, FirstName = "Carl", LastName = "Barks", BirthDate = new DateTime(1901, 3, 27), Created = DateTime.Now, ImagePath = "/images/Authors/3.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 4, FirstName = "Dave", LastName = "Pelzer", BirthDate = new DateTime(1960, 12, 29), Created = DateTime.Now, ImagePath = "/images/Authors/4.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 4 },
                new Author { Id = 5, FirstName = "John", LastName = "Cho", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/Authors/5.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 5 },
                new Author { Id = 6, FirstName = "Sally", LastName = "Rooney", BirthDate = new DateTime(1991, 2, 20), Created = DateTime.Now, ImagePath = "/images/Authors/6.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 7, FirstName = "Laura", LastName = "Dave", BirthDate = new DateTime(1977, 7, 18), Created = DateTime.Now, ImagePath = "/images/Authors/7.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 4 },
                new Author { Id = 8, FirstName = "Taylor", LastName = "Reid", BirthDate = new DateTime(1983, 12, 20), Created = DateTime.Now, ImagePath = "/images/Authors/8.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 2 },
                new Author { Id = 9, FirstName = "Sarah", LastName = "Maas", BirthDate = new DateTime(1986, 3, 5), Created = DateTime.Now, ImagePath = "/images/Authors/9.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 10, FirstName = "Jenny", LastName = "Lawson", BirthDate = new DateTime(1973, 12, 29), Created = DateTime.Now, ImagePath = "/images/Authors/10.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 5 },
                new Author { Id = 11, FirstName = "Grady", LastName = "Hendrix", BirthDate = new DateTime(1948, 5, 13), Created = DateTime.Now, ImagePath = "/images/Authors/11.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 12, FirstName = "Andy", LastName = "Weir", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/Authors/12.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 1 },
                new Author { Id = 13, FirstName = "Emily", LastName = "Henry", BirthDate = new DateTime(1995, 11, 17), Created = DateTime.Now, ImagePath = "/images/Authors/13.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 14, FirstName = "John", LastName = "Green", BirthDate = new DateTime(1977, 8, 24), Created = DateTime.Now, ImagePath = "/images/Authors/14.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 4 },
                new Author { Id = 15, FirstName = "Michelle", LastName = "Zauner", BirthDate = new DateTime(1989, 3, 29), Created = DateTime.Now, ImagePath = "/images/Authors/15.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 5 },
                new Author { Id = 16, FirstName = "Patrick", LastName = "Keefe", BirthDate = new DateTime(1976, 1, 15), Created = DateTime.Now, ImagePath = "/images/Authors/16.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 17, FirstName = "Rachel", LastName = "Smythe", BirthDate = new DateTime(1986, 9, 19), Created = DateTime.Now, ImagePath = "/images/Authors/17.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 3 },
                new Author { Id = 18, FirstName = "Leigh", LastName = "Bardugo", BirthDate = new DateTime(1975, 5, 6), Created = DateTime.Now, ImagePath = "/images/Authors/18.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 4 },
                new Author { Id = 19, FirstName = "Angeline", LastName = "Boulley", BirthDate = new DateTime(1966, 4, 27), Created = DateTime.Now, ImagePath = "/images/Authors/19.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 4 },
                new Author { Id = 20, FirstName = "Elena", LastName = "Armas", BirthDate = new DateTime(1989, 1, 30), Created = DateTime.Now, ImagePath = "/images/Authors/20.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 2 }
