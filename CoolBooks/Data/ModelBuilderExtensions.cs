    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void SeedAuthor(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>()
                .HasData(
                new Author { Id = 1, FirstName = "Andrzej", LastName = "Sapkowski", BirthDate = new DateTime(1948, 6, 21), Created = DateTime.Now, ImagePath = "/images/andrzej.jpg" },
                new Author { Id = 2, FirstName = "Richard", LastName = "Osman", BirthDate = new DateTime(1970, 11, 28), Created = DateTime.Now, ImagePath = "/images/richard.jpg" },
                new Author { Id = 3, FirstName = "Carl", LastName = "Barks", BirthDate = new DateTime(1901, 3, 27), Created = DateTime.Now, ImagePath = "/images/carlbarks.jpg" },
                new Author { Id = 4, FirstName = "Dave", LastName = "Pelzer", BirthDate = new DateTime(1960, 12, 29), Created = DateTime.Now, ImagePath = "/images/davepelzer.jpg"},
                new Author { Id = 5, FirstName = "John", LastName = "Cho", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/johncho.jpg"}
                // new Author { Id = , FirstName = "", LastName = "", BirthDate = new DateTime(2000, 12, 24), Created = DateTime.Now, ImagePath = ""}
                // Den utkommenterade raden är en mall så man kan lägga till mer seed-data med snabbare copy paste arbete. Glöm inte , på raden innan!
                );
        }
