    ...
    public static class ModelBuilderExtensions
    {
        ...
        public static void SeedAuthor(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Author>()
                .HasData(
                new Author { Id = 1, FirstName = "Andrzej", LastName = "Sapkowski", BirthDate = new DateTime(1948, 6, 21), Created = DateTime.Now, ImagePath = "/images/Authors/1.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating=0 },
                new Author { Id = 2, FirstName = "Richard", LastName = "Osman", BirthDate = new DateTime(1970, 11, 28), Created = DateTime.Now, ImagePath = "/images/Authors/2.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 3, FirstName = "Carl", LastName = "Barks", BirthDate = new DateTime(1901, 3, 27), Created = DateTime.Now, ImagePath = "/images/Authors/3.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 4, FirstName = "Dave", LastName = "Pelzer", BirthDate = new DateTime(1960, 12, 29), Created = DateTime.Now, ImagePath = "/images/Authors/4.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 5, FirstName = "John", LastName = "Cho", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/Authors/5.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 6, FirstName = "Sally", LastName = "Rooney", BirthDate = new DateTime(1991, 2, 20), Created = DateTime.Now, ImagePath = "/images/Authors/6.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 7, FirstName = "Laura", LastName = "Dave", BirthDate = new DateTime(1977, 7, 18), Created = DateTime.Now, ImagePath = "/images/Authors/7.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 8, FirstName = "Taylor", LastName = "Reid", BirthDate = new DateTime(1983, 12, 20), Created = DateTime.Now, ImagePath = "/images/Authors/8.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 9, FirstName = "Sarah", LastName = "Maas", BirthDate = new DateTime(1986, 3, 5), Created = DateTime.Now, ImagePath = "/images/Authors/9.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 10, FirstName = "Jenny", LastName = "Lawson", BirthDate = new DateTime(1973, 12, 29), Created = DateTime.Now, ImagePath = "/images/Authors/10.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 11, FirstName = "Grady", LastName = "Hendrix", BirthDate = new DateTime(1948, 5, 13), Created = DateTime.Now, ImagePath = "/images/Authors/11.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 12, FirstName = "Andy", LastName = "Weir", BirthDate = new DateTime(1972, 6, 16), Created = DateTime.Now, ImagePath = "/images/Authors/12.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 13, FirstName = "Emily", LastName = "Henry", BirthDate = new DateTime(1995, 11, 17), Created = DateTime.Now, ImagePath = "/images/Authors/13.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 14, FirstName = "John", LastName = "Green", BirthDate = new DateTime(1977, 8, 24), Created = DateTime.Now, ImagePath = "/images/Authors/14.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 15, FirstName = "Michelle", LastName = "Zauner", BirthDate = new DateTime(1989, 3, 29), Created = DateTime.Now, ImagePath = "/images/Authors/15.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 16, FirstName = "Patrick", LastName = "Keefe", BirthDate = new DateTime(1976, 1, 15), Created = DateTime.Now, ImagePath = "/images/Authors/16.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 17, FirstName = "Rachel", LastName = "Smythe", BirthDate = new DateTime(1986, 9, 19), Created = DateTime.Now, ImagePath = "/images/Authors/17.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 18, FirstName = "Leigh", LastName = "Bardugo", BirthDate = new DateTime(1975, 5, 6), Created = DateTime.Now, ImagePath = "/images/Authors/18.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 19, FirstName = "Angeline", LastName = "Boulley", BirthDate = new DateTime(1966, 4, 27), Created = DateTime.Now, ImagePath = "/images/Authors/19.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 },
                new Author { Id = 20, FirstName = "Elena", LastName = "Armas", BirthDate = new DateTime(1989, 1, 30), Created = DateTime.Now, ImagePath = "/images/Authors/20.jpg", CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5", Rating = 0 }
                // new Author { Id = , FirstName = "", LastName = "", BirthDate = new DateTime(2000, 12, 24), Created = DateTime.Now, ImagePath = "images/Authors/.jpg", Rating=0}
                // Den utkommenterade raden är en mall så man kan lägga till mer seed-data med snabbare copy paste arbete. Glöm inte , på raden innan!
                );
        }
        ...
        public static void SeedReview(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Review>()
                ...
                new Review { LikeCount = 3, DisLikeCount = 1, Id = 3, BookId = 3, Title = "Sages review", Text = "With the exception of a few horribly racist remnants of the age these comics come from, it's a delightful collection of some of the best comics ever.", Rating = 4, Created = DateTime.Now, CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5" },
                new Review { LikeCount = 0, DisLikeCount = 0, Id = 4, BookId = 4, Title = "Delenns review", Text = "I had to read this one after The Child Called It. It was also compelling and opened my eyes to the foster care system.", Rating = 4, Created = DateTime.Now, CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5" },
                ...
                new Review { LikeCount = 0, DisLikeCount = 0, Id = 6, BookId = 6, Title = "Eoins review", Text = "when i was diagnosed with covid i thought that being isolated to my bedroom for two weeks was the most boring thing in the world - Sally Rooney has now proven me wrong.", Rating = 1, Created = DateTime.Now, CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5" },
                new Review { LikeCount = 0, DisLikeCount = 0, Id = 7, BookId = 7, Title = "Emilys review", Text = "I'm wondering how these books become the winner's of the CoolBooks Choice Awards. Are we reading the same books ? This was....meh ", Rating = 2, Created = DateTime.Now, CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5" },
                ...
                new Review { LikeCount = 0, DisLikeCount = 0, Id = 9, BookId = 9, Title = "Cindys review", Text = "I took an edible and now I'm too high to write this review", Rating = 2, Created = DateTime.Now, CreatedBy = "b74ddd14-6340-4840-95c2-db12554843e5" },
        ...
        public static void SeedComment(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Comment>().HasData(
                ...
                new Comment { Id = 7, commentId = 6, Text = "Third level! Comment on comment wuwu!", Created = DateTime.Now, CreatedBy = "Stefan" },
